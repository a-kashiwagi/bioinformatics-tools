...
int Procedure(
	...
	if( alignment_mode == GLOBAL_ALIGNMENT ){
		...
		v_ans  = (char *)malloc( inum + jnum + 1 );
		w_ans  = (char *)malloc( inum + jnum + 1 );
		ans    = (char *)malloc( inum + jnum + 1 );
		bp_arr = (char *)malloc( inum + jnum + 1 );
						/* +1 mean footer NULL       */
		...
		v_ans  = (char *)malloc( local_inum + local_jnum + 1 );
		w_ans  = (char *)malloc( local_inum + local_jnum + 1 );
		ans    = (char *)malloc( local_inum + local_jnum + 1 );
		bp_arr = (char *)malloc( local_inum + local_jnum + 1 );
						/* +1 mean footer NULL       */
